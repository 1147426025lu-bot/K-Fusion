...
/*
 * Pi5 PL011 page base for bootstrap PT virt+phys offset math in entry.S
 * (phys 0x107d001000 → offset 0x1000 → virt 0x107d001000)
 */
#define UART_BASE		0x107d000000UL
#define RPI5_UART_PL011		0x107d001000UL
#else
