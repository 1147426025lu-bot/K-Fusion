...
extern char bootstrap_vectors[];
extern char el2_entry[];
#endif
...
#if defined(__aarch64__)
	.bootstrap_vectors_off = (unsigned long)bootstrap_vectors - JAILHOUSE_BASE,
	.el2_entry_off = (unsigned long)el2_entry - JAILHOUSE_BASE,
#endif
};
