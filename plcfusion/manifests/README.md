...
| `manifest_plc_multitask__*` | `examples/plc_multitask__*` + `src/runtime/plc_let__LET.c` | W5 STRICT LET 多 job |
| `manifest_plc_multitask_paper__*` | 同上 + `FUSE_PIPELINE=debug` | 论文 W5 测量（duration 驱动） |
