...
RESULTS_PNG="$RESULTS_ROOT/${MEASURE_KIND:-soak}/png"
RESULTS_RAW="$RESULTS_ROOT/${MEASURE_KIND:-soak}/raw"
cd "$SCRIPT_DIR"

export PRE_IDLE_SEC="${PRE_IDLE_SEC:-90}"
export RING_EXPORT_PATH="${RING_EXPORT_PATH:-$RESULTS_ROOT/jitter.bin}"
...
JITTER_BIN="${RING_EXPORT_PATH:-$RESULTS_ROOT/jitter.bin}"
