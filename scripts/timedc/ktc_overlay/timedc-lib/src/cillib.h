...
#ifdef KTC_RUNTIME_LIB
#define KTC_VAR extern
#else
#define KTC_VAR
#endif

KTC_VAR struct timespec* timepecptr;
KTC_VAR timer_t ftimer;
KTC_VAR sigset_t sigtype;
...
KTC_VAR bool boolvar;
KTC_VAR struct tp_struct tp_struct_data;
KTC_VAR int list_pr[500];
KTC_VAR int list_dl[500];
...
KTC_VAR struct sched_attr sae;
KTC_VAR struct fifolist fifoex;
...
KTC_VAR pthread_t pthread_id_example;
